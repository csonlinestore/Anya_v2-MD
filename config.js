...
module.exports = {
     ...
     */
    botname: process.env.BotName || "Chamod Assistant",
    footer: process.env.Footer || "© Chamod Security System",
     ...
     */
    ownername: process.env.Owner_Name || "CHAMOD DESHAN",
    ownernumber: process.env.Owner_Number || "94762377580",
    instagramId: process.env.Insta || "chamod_deshan",

    /**
     * other details and parameters
     */
    author: process.env.Author || "chamod deshan",
    packname: process.env.PackName || "CHAMOD ASSISTAN",
    ...
    mongoUrl: process.env.MongoDB || "mongodb+srv://chamod:mongochamod@cluster0.uhcpl.mongodb.net/",
    sessionId: process.env.SESSION_ID || "N_AN_YA_3M2ZzN_AN_YA_6MWg=",
